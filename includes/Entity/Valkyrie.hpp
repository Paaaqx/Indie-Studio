//
// Valkyrie.hpp for  in /home/mex/rendu/tek2/c++/cpp_indie_studio
// 
// Made by Mex
// Login   <maximilien.oteifeh-pfennig@epitech.eu>
// 
// Started on  Tue Jun  6 15:51:49 2017 Mex
// Last update Sun Jun 18 22:27:08 2017 Paqx
//
...
class					Valkyrie : public IEntity
{
public:
  Valkyrie(Core *core, irr::core::vector3df pos);
  ~Valkyrie();
...
private:
  ...
  int					_nextRotation;
  std::vector<std::string>		_valkyrieMeshs;
  std::vector<MeshManager*>		_valkyrieActualMeshs;
  bool					_select;
  bool					_attack;
  bool					_death;
  int					_maxLifePoint;
